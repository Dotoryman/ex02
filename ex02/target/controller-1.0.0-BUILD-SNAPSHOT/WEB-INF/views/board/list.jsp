	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				Board List Page
				<button id="regBtn" class="btn btn-xs pull-right">Register
					New Board</button>
			</div>
			<!-- /.panel-heading -->
				...
				<div class="pull-right">
					<ul class="pagination">
						...
						<c:forEach var="num" begin="${pageMaker.startPage }"
							...
							<li
								class="pagenate_button ${pageMaker.cri.pageNum == num ? 'active' : '' }">
								<a href="${num }">${num }</a>
							</li>
						</c:forEach>
				...
				<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">등록메세지~!~!~!</div>
...
<script>
	$(document).ready(function() {
		...
		// 모달창을 활용해서 메세지 보여주도록
		checkModal(result);
		// history 객체에 state 속성
		// state의 속성이 null: 등록/수정/삭제 후 목록페이지로 이동할 경우.
		...
		$('.pagenate_button a').on('click', function(e) {
			e.preventDefault();
			//a태그의 href속성이 페이지번호. form submit()이벤트를 발생
